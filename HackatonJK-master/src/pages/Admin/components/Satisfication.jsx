    ...
    return (
        <div className="p-4 h-full">
            <div className="flex justify-between items-center">
                <div className="text-white font-bold">Конверсия</div>
                <Icon path="res-react-dash-options" className="w-2 h-2" />
            </div>
            <div className="mt-3">Из всех проектов</div>
            <div className="flex justify-center">
                ...
                >
                    ...
                    />
                    <animated.path
                        d="M100 350C100 283.696 126.339 220.107 173.223 173.223C220.107 126.339 283.696 100 350 100C416.304 100 479.893 126.339 "
                        stroke="#2f49d0"
                        strokeWidth="40"
                        strokeLinecap="round"
                    ...
                    <animated.circle
                        cx={dashOffset.interpolate(
                            (x) => 350 + 250 * Math.cos(map(x, 162.4, 0, pi, tau)),
                        )}
                        cy={dashOffset.interpolate(
                            (x) => 350 + 250 * Math.sin(map(x, 162.4, 0, pi, tau)),
                        )}
                        r="12"
                        fill="#fff"
                    />
